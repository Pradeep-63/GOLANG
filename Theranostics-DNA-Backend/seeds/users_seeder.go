...
func SeedUsers() {
	...
	users := []struct {
	...
	}{
		{
			FirstName: "Client",
			LastName:  "SuperAdmin",
			Email:     "client.superadmin@yopmail.com",
			RoleName:  "super-admin",
		},
		{
			FirstName: "Dev",
			LastName:  "SuperAdmin",
			Email:     "dev.superadmin@yopmail.com",
			RoleName:  "super-admin",
		},
		{
			FirstName: "Test",
			LastName:  "SuperAdmin",
			Email:     "test.superadmin@yopmail.com",
			RoleName:  "super-admin",
		},
		{
			FirstName: "Client",
			LastName:  "Admin",
			Email:     "client.admin@yopmail.com",
			RoleName:  "admin",
		},
		{
			FirstName: "Dev",
		...
		},
		{
			FirstName: "Client",
			LastName:  "User",
			Email:     "client.user@yopmail.com",
			RoleName:  "user",
		},
		{
			FirstName: "Dev",
			LastName:  "User",
			Email:     "dev.user@yopmail.com",
			RoleName:  "user",
		},
		{
			FirstName: "Test",
